...
<>
	...
	<p className="text-red py-3 rounded-lg text-base font-sans">To register with us...</p>
	<ol className="text-red py-3 rounded-lg text-base font-sans">
	...
	<p className="text-red py-3 rounded-lg text-base"> After registration...</p>
	<ol className="text-red py-3 rounded-lg text-base font-sans">
